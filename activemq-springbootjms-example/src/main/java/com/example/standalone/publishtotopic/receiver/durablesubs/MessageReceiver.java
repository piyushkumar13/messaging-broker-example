...
public class MessageReceiver {
    ...
    @JmsListener(destination = "my_topic", containerFactory = "customJmsListenerContainerFactory1", subscription = "subscriber1")
    ...
    @JmsListener(destination = "my_topic", containerFactory = "customJmsListenerContainerFactory2")
