package com.example.rabbitmqspringbootexample.header.receiver;
...
public class MessageConfig {
    public static final String QUEUE_NAME_1 = "myboot_header_queue1";
    public static final String QUEUE_NAME_2 = "myboot_header_queue2";
    public static final String QUEUE_NAME_3 = "myboot_header_queue3";
